...
- **Why zoom 7, 2×2 tiles, 768 px crop**: Rain Viewer free tier max is zoom 7, 512 px tiles. One tile ≈ 200 km at Brno's latitude. 2×2 = ~400 km, cropped to 768 px ≈ 300 km square centered on Brno.
...
| `CROP_SIZE`        | 768     | Output square size in px                             |
